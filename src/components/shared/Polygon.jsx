...
export default function Polygon({ className, isHovered }) {
  ...
  return (
    ...
    >
      <div
        className={`z-10 transition-all duration-1000 ${isHovered ? 'drop-shadow-[0_0_10px_rgba(233,147,207,0.8),_0_0_20px_rgba(233,147,207,0.8),_0_0_40px_rgba(233,147,207,0.8)]' : ''}`}
      >
